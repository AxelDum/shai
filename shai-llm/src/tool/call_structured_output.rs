...
use openai_dive::v1::resources::chat::{
    ...
    ChatCompletionResponseFormat, ChatMessage, ChatMessageContent, Function, JsonSchemaBuilder,
...
impl StructuredOutputBuilder for ChatCompletionParametersBuilder {
    ...
    fn with_structured_output(&mut self, tools: &ToolBox) -> &mut ChatCompletionParametersBuilder {
    ...
    async fn chat_with_tools_so(
        ...
        let structured_response: AssistantResponse = match &response.choices[0].message {
            ChatMessage::Assistant {
                ...
                LlmError::from(format!("Failed to parse structured response: {}", e))
            })?,
